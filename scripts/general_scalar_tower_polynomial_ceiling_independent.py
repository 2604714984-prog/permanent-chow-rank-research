...
parameter range, and checks the exact finite normalization table used as
regression evidence for the asymptotic theorem.
"""
...
def check_hypergeometric_interface() -> tuple[int, int]:
    ...
    require(parameter_pairs > 400, parameter_pairs)
    require(inequalities > 10_000, inequalities)
