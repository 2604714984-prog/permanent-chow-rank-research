#!/usr/bin/env python3
"""Efficient independent replay for the private-polar zero band.

This implementation imports none of the primary helpers.  It scans all legal
integer rows directly through m=256 and reconstructs the quartic rectangle
minimum from the complete labelled overlap distributions of three-subsets.
"""
...
def main() -> int:
    ...
    require(not any(key == (3, False) for key in overlap_histogram), overlap_histogram)
