...
| S5-001 | `PROOF_DRAFT_COMPLETE`, `COMPUTATION_REPLAYED` | `ChowRank(perm_5)=16` over characteristic-zero fields | v13 program-free finite-combinatorial proof; redundant exact rational audit of all 32,768 terminal subsets; external review pending |
...
- The v13 `n=5` argument has not received independent external mathematical review or proof-assistant formalization. Its proof no longer depends on the omitted lower-15 SAT/DRAT layer.
