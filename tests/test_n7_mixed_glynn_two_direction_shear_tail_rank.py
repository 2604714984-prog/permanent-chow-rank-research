...
def load_script():
    path = ROOT / "scripts" / "n7_mixed_glynn_two_direction_shear_tail_rank.py"
    spec = importlib.util.spec_from_file_location("n7_two_direction_shear", path)
...
class TwoDirectionShearTailRankTests(unittest.TestCase):
    @classmethod
    def setUpClass(cls):
        ...
        cls.row = json.loads(
            (
                ROOT
                / "data"
                / "n7_mixed_glynn_two_direction_shear_tail_rank.json"
