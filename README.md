...
| `n=6` critical biflag exclusion | exact characteristic-zero `4x3` graph certificates; pure projective-torus globalization | the three remaining `4x3` charts have kernels `18,30,28`, exactly product directions plus `12,24,24` truncated directions; pure truncated weights have rank 6 and vanish; all six fixed-point charts are therefore product at threshold 13, projective component globalization puts the entire biflag high-intersection locus in the closed product locus, and N6-068 excludes the `(a2,kappa2,t2)=(72,3,15)` biflag branch; the 13/14-dimensional partial-pair product layer and eight other lower-29 scalar states remain |
