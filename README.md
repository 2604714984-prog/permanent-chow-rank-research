...
| `n=7` | audited ordinary lower-bound proof; exact independent replays; exact-head CI | `50<=ChowRank(perm_7)<=64` over an algebraically closed characteristic-zero field; the proof combines exact section caps, universal middle symbols, exhaustive 49-term endpoint packets, and corrected degree-three/four projection arguments; exact rank 64 and border rank remain open |
