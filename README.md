...
| `n=6` lower-29 fixed-six frontier | pure fixed-six and equality-locus reductions; exact integer/rational replay; partial | the 47--49 extension ladder excludes `b=31,32,33,47,48,49`; the strict frontier is `34<=b<=46`; at `b=34`, uniform seven-deletion stability of the 73--80 product-shadow-90 locus and an actual seven-frame block exclusion force every residual seven-set shortening to have dimension at most 72 |
