...
| `n=5` | repaired proof draft complete; fresh external review pending | `ChowRank(perm_5)=16`; v14 supplies a characteristic-zero projective degeneration and a deterministic exact endpoint certificate over 886,464 flags |
